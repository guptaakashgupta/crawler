import sys
sys.path.insert(0,'/media/akash/My Passport/Dropbox/projectmooc/projectmooc')
...
stanford_dip_ee368="/media/akash/My Passport/Dropbox/crawler/stanford/image processing/stanford_dip_ee368.json"
stanford_ml_cs229="/media/akash/My Passport/Dropbox/crawler/stanford/machine learning/stanford_ml_data_cs229.json"
...
def stanford_dip():
	...
	dip_tag=TagHead.objects.get_or_create(name="Digital Image Processing")
	...
	for project in data:
		...
		university_project.tags_head.add(tag_head)
...
def stanford_ml():
	...
	for index,project in enumerate(data):
		...
		for author in authors_list:
			university_project.author.add(author)
		university_project.tags_head.add(ml_tag)
		print university_project
