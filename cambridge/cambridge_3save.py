...
FilePath='/home/akash/Desktop/cambridge_3.json'
...
for project in jsonData:
    ...
    university_project,flag=UniversityProject.objects.get_or_create(title=title,level='ADV',home_url=home_url,
                                                                    url=project_url,image_url=img_url,
                                                                    year=int(year),score=1,university=university,
                                                                    type_of_project='RSH',long_description=description)
